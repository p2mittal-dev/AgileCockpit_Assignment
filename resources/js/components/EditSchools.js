...
class EditSchools extends React.Component {
  state = {
  ...
  handleSubmit = e => {
    ...
    updateSchool = async (e) => {
        ...
        const res = await axios.patch(`/addSchool/${id}`, this.state);
    ...
    async componentDidMount() {
        const id = this.props.match.params.id;
        const res = await axios.get(`/addSchool/${id}/edit`);
        this.setState({name: res.data.schools.name});
        this.setState({email: res.data.schools.email});
        this.setState({mobile: res.data.schools.mobile});
        this.setState({username: res.data.schools.username});
        this.setState({address: res.data.schools.address});
    }
    render() {
        const form = (
